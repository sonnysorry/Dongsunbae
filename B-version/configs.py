...
tf.app.flags.DEFINE_string('data_path', 'C:/Users/user/Desktop/farm chal/B-version/data_in/ChatBotDataa.csv', 'data path') # 데이터 위치
tf.app.flags.DEFINE_string('vocabulary_path', 'C:/Users/user/Desktop/farm chal/B-version/data_out/vocabularydata.voc', 'vocabulary path') # 사전 위치
tf.app.flags.DEFINE_string('check_point_path', 'C:/Users/user/Desktop/farm chal/B-version/data_out/check_point', 'check point path') # 체크포인트 위치
tf.app.flags.DEFINE_string('save_model_path', 'C:/Users/user/Desktop/farm chal/B-version/data_out', 'save model') # 모델 저장 경로
...
tf.app.flags.DEFINE_boolean('serving', True, 'Use Serving') # 서빙 기능 지원여부
tf.app.flags.DEFINE_boolean('loss_mask', True, 'Use loss mask') # PAD에 대한 마스크를 통한 loss 제한
